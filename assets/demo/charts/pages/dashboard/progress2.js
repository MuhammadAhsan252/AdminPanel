...
var DashboardProgress = function() {
    ...
    return {
        init: function() {
            _ProgressRoundedChart('#hours-available-progress', 38, 2, '#4cb6ac', 0.77, 'ph-check text-success', 'Pass');
            _ProgressRoundedChart('#goal-progress', 38, 2, '#F06292', 0.23, 'ph-x text-danger', 'Deny');
        }
    }
}();
